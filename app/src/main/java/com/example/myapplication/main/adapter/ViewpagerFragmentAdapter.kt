...
import com.example.myapplication.main.RegisterFragment
import com.example.myapplication.main.StoreFragment

class ViewpagerFragmentAdapter(fragmentActivity: FragmentActivity): FragmentStateAdapter(fragmentActivity) {

    // 1. ViewPager2에 연결할 Fragment 들을 생성
    val fragmentList = listOf<Fragment>(HomeFragment(), RegisterFragment(), StoreFragment(), ProfileFragment())
